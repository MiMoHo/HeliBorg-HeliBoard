...
fun PreferencesScreen(
    ...
    val items = listOf(
        ...
        Settings.PREF_SHOW_SYMBOL_HINTS,
...
fun createPreferencesSettings(context: Context) = listOf(
    ...
    Setting(context, Settings.PREF_SHOW_SYMBOL_HINTS, R.string.show_symbol_hints, R.string.show_symbol_hints_summary) {
        SwitchPreference(it, Defaults.PREF_SHOW_SYMBOL_HINTS) { KeyboardSwitcher.getInstance().setThemeNeedsReload() }
    },
